    ...
    <section>
      ...
      <div className="flex flex-col gap-2.5">
        <div className="flex items-center gap-2">
          <input type="color" value={accent || "#4e6073"} onChange={(e) => updateProps({ id: el.id, props: { accentColor: e.target.value } })} className="size-7 cursor-pointer rounded-md border border-border bg-transparent p-0.5" />
          <div className="flex-1">
            ...
            <input
              ...
              onChange={(e) => updateProps({ id: el.id, props: { accentColor: e.target.value || undefined } })}
        ...
        <div className="flex items-center gap-2">
          <input type="color" value={bg || "#faf9f8"} onChange={(e) => updateProps({ id: el.id, props: { backgroundColor: e.target.value } })} className="size-7 cursor-pointer rounded-md border border-border bg-transparent p-0.5" />
          <div className="flex-1">
            ...
            <input
              ...
              onChange={(e) => updateProps({ id: el.id, props: { backgroundColor: e.target.value || undefined } })}
              onKeyDown={(e) => e.stopPropagation()}
              className="w-full rounded-md border border-border bg-surface px-2 py-1 font-mono text-[11px] text-foreground outline-none placeholder:text-muted-foreground/40 focus:border-ring"
            />
          </div>
        ...
        <div className="flex items-center gap-2">
          <input type="color" value={text || "#2f3333"} onChange={(e) => updateProps({ id: el.id, props: { textColor: e.target.value } })} className="size-7 cursor-pointer rounded-md border border-border bg-transparent p-0.5" />
          <div className="flex-1">
            ...
            <input
              ...
              onChange={(e) => updateProps({ id: el.id, props: { textColor: e.target.value || undefined } })}
              onKeyDown={(e) => e.stopPropagation()}
              className="w-full rounded-md border border-border bg-surface px-2 py-1 font-mono text-[11px] text-foreground outline-none placeholder:text-muted-foreground/40 focus:border-ring"
            />
          </div>
        ...
        {accent && (
          <button
            onClick={() => updateProps({ id: el.id, props: { accentColor: undefined, backgroundColor: undefined, textColor: undefined } })}
